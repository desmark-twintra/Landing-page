...
/**
 * The enquiry-list sheet — lists the client-side selection built from product
 * pages, lets the buyer trim it, then hands off to the enquiry form on
 * /contact (no drawer, no new submission path). Hand-rolled the same way as
 * QuoteDrawer rather than a @base-ui/react primitive, to match the one modal
      ...
      {open && (
        <div className="fixed inset-0 z-[100]">
          ...
          <motion.div
            ...
            role="dialog"
            aria-modal="true"
            aria-labelledby="enquiry-list-title"
          ...
          >
            ...
            <div className="mt-3 flex shrink-0 items-baseline justify-between gap-3">
              <h2 id="enquiry-list-title" className="font-display text-xl text-heading">
                Your enquiry list
              </h2>
            ...
            {items.length > 0 ? (
              ...
              <div className="py-2">
                <p className="mt-2 text-[14.5px] leading-relaxed text-ink-mid">
                  Nothing added yet. Add products from their detail pages and
                  they&apos;ll travel into your enquiry — one message for the
                  whole list.
                </p>
